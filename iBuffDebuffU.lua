...
local function createHeaders()
	...
	--buff
	buffHeader:SetAllPoints(_G[anchors["player"]])
	...
	--debuff
	debuffHeader:SetAllPoints(_G[anchors["target"]])
...
function f:PLAYER_ENTERING_WORLD()
	--reload or entering a zone refresh display
	f:UNIT_AURA(nil, "player")
end
...
if IsLoggedIn() then f:PLAYER_LOGIN() else f:RegisterEvent("PLAYER_LOGIN") f:RegisterEvent("PLAYER_ENTERING_WORLD") end
